...
public class CmdLineParser
{
	...
	public static abstract class Option
	{
		...
		{
			String s1 = shortForm != null ? "-" + shortForm : "";
			if (shortForm != null)
			{
				s1 += ",";
			}
			s1 += longForm != null ? " --" + longForm : "";
			if (longForm != null)
			{
				s1 += ",";
			}
		...
		protected Option(String longForm, boolean wantsValue, String description)
		{
			this(null, longForm, wantsValue, description);
		}

		protected Option(char shortForm, String longForm, boolean wantsValue, String description)
		{
			this(new String(new char[]
			{
				shortForm
			}), longForm, wantsValue, description);
		}

		private Option(String shortForm, String longForm, boolean wantsValue, String description)
		{
		...
		public void setWantValue(boolean b)
		{
			this.wantsValue = b;
		}
		...
		public static class BooleanOption extends Option
		{
			...
			{
				super(shortForm, longForm, false, description);
			}

			public BooleanOption(String longForm, String description)
			{
				super(longForm, false, description);
			}
		}
		...
		public static class IntegerOption extends Option
		{
			...
			{
				super(shortForm, longForm, true,description);
			}

			public IntegerOption(String longForm, String description)
			{
				super(longForm, true,description);
			}
		...
		{
			public StringOption(char shortForm, String longForm, String description)
			{
				super(shortForm, longForm, true, description);
			}

			public StringOption(String longForm, String description)
			{
				super(longForm, true, description);
			}
	...
	public final Option addOption(Option opt)
	{
		...
		this.longForms.put("--" + opt.longForm(), opt);
		return opt;
	}
	 ...
	 * @return the new Option
	 */
	public final Option addStringOption(char shortForm, String longForm, String description)
	{
		return addOption(new Option.StringOption(shortForm, longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addStringOption(String longForm, String description)
	{
		return addOption(new Option.StringOption(longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addIntegerOption(char shortForm, String longForm, String description)
	{
		return addOption(new Option.IntegerOption(shortForm, longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addIntegerOption(String longForm, String description)
	{
		return addOption(new Option.IntegerOption(longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addLongOption(char shortForm, String longForm, String description)
	{
		return addOption(new Option.LongOption(shortForm, longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addLongOption(String longForm, String description)
	{
		return addOption(new Option.LongOption(longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addDoubleOption(char shortForm, String longForm, String description)
	{
		return addOption(new Option.DoubleOption(shortForm, longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addDoubleOption(String longForm, String description)
	{
		return addOption(new Option.DoubleOption(longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addBooleanOption(char shortForm, String longForm, String description)
	{
		return addOption(new Option.BooleanOption(shortForm, longForm, description));
	}
	 ...
	 * @return the new Option
	 */
	public final Option addBooleanOption(String longForm, String description)
	{
		return addOption(new Option.BooleanOption(longForm, description));
	}	
	 ...
	 */
	public final Object getOptionValue(Option o) throws IllegalOptionValueException
	{
		return getOptionValue(o, null);
	}
	
	public final Object getOptionValue(String longform) throws IllegalOptionValueException
	{
		return getOptionValue(longform, null);
	}
	
	public final Object getOptionValue2(String longform, Object def) throws IllegalOptionValueException
	{
	 ...
	 * @throws IllegalOptionValueException 
	 */
	public final Object getOptionValue(Option o, Object def) throws IllegalOptionValueException
	{
	...
	public Option getOption(String longForm)
	{
		return (Option) longForms.get("--"+longForm);
	}
